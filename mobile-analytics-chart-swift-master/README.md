...
[Link to Changelog](https://git.yoomoney.ru/projects/SDK/repos/mobile-analytics-chart-swift/browse/CHANGELOG.md)
...
```swift
dependencies: [
  .package(url: "https://git.yoomoney.ru/projects/SDK/repos/mobile-analytics-chart-swift")
],
targets: [
  .target(
    name: "MyProject",
...
3. Add dependencie in `Podfile`.\
   [Example](https://git.yoomoney.ru/projects/SDK/repos/mobile-analytics-chart-swift/browse/MobileAnalyticsChartSwiftExampleCarthage/Podfile-example) `Podfile`from demo-app.
...
pod 'MobileAnalyticsChartSwift',
  :git => 'https://git.yoomoney.ru/scm/sdk/mobile-analytics-chart-swift.git',
  :tag => 'tag'
end
```
...
```shell
git clone https://git.yoomoney.ru/scm/sdk/mobile-analytics-chart-swift.git
```
...
5. Select and run a scheme `MobileAnalyticsChartSwiftExampleCarthage`.

## License

Mobile Analytics Chart Swift available under the MIT license. See the [LICENSE](https://git.yoomoney.ru/projects/SDK/repos/mobile-analytics-chart-swift/browse/LICENSE) file for more information.
